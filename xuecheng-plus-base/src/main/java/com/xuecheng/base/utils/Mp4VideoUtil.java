...
//        Boolean check_video_time = this.check_video_time(video_path, mp4folder_path + mp4_name);
    ...
    public static void main(String[] args) throws IOException {
        //ffmpeg的路径
        String ffmpeg_path = "D:\\xuecheng-plus\\ffmpeg\\ffmpeg.exe";//ffmpeg的安装位置
        //源avi视频的路径
        String video_path = "D:\\xuecheng-plus\\video\\saiche.mp4";
        //转换后mp4文件的名称
        String mp4_name = "saiche.avi";
        //转换后mp4文件的路径
        String mp4_path = "D:\\xuecheng-plus\\video\\saiche.avi";
        //创建工具类对象
