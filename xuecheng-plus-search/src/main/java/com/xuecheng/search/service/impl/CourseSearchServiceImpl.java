...
public class CourseSearchServiceImpl implements CourseSearchService {
    ...
    public SearchPageResultDto<CourseIndex> queryCoursePubIndex(PageParams pageParams, SearchCourseParamDto searchCourseParamDto) {
        ...
        if (StringUtils.isNotEmpty(searchCourseParamDto.getMt())) {
            boolQuery.filter(QueryBuilders.termQuery("mtName",searchCourseParamDto.getMt()));
        }
        if (StringUtils.isNotEmpty(searchCourseParamDto.getSt())) {
            boolQuery.filter(QueryBuilders.termQuery("stName",searchCourseParamDto.getSt()));
        }
        if (StringUtils.isNotEmpty(searchCourseParamDto.getGrade())) {
            boolQuery.filter(QueryBuilders.termQuery("grade",searchCourseParamDto.getGrade()));
        }
        ...
        SearchPageResultDto<CourseIndex> courseIndexSearchPageResultDto = new SearchPageResultDto<>(courseIndexList, hits.getTotalHits().value, pageNo, pageSize);
        List<String> mtAgg = getAggregation(searchResponse.getAggregations(), "mtAgg");
        List<String> stAgg = getAggregation(searchResponse.getAggregations(), "stAgg");
        courseIndexSearchPageResultDto.setMtList(mtAgg);
        courseIndexSearchPageResultDto.setStList(stAgg);
